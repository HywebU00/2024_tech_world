var ScrollyVideo = (function () {
    ...
    l.initialize(),
      ...
      l.createFullBoxCtor('emsg', function (t) {
        1 == this.version
          ...
          : ((this.scheme_id_uri = t.readCString()), (this.value = t.readCString()), (this.timescale = t.readUint32()), (this.presentation_time_delta = t.readUint32()), (this.event_duration = t.readUint32()), (this.id = t.readUint32()));
        ...
        for (var e = t.readUint32(), i = 0; i < e; i++) {
          ...
          (s = l[this.grouping_type + 'SampleGroupEntry'] ? new l[this.grouping_type + 'SampleGroupEntry'](this.grouping_type) : new l.SampleGroupEntry(this.grouping_type)),
            ...
            s.write === l.SampleGroupEntry.prototype.write &&
              (r.info('BoxParser', 'SampleGroup for type ' + this.grouping_type + ' writing not yet implemented, keeping unparsed data in memory for later write'), (s.data = t.readUint8Array(s.description_length)), (t.position -= s.description_length)),
            s.parse(t);
        }
      }),
      ...
      l.createFullBoxCtor('stsd', function (t) {
        ...
        for (this.entries = [], s = t.readUint32(), e = 1; e <= s; e++) {
          ...
          l[i.type + 'SampleEntry'] ? (((n = new l[i.type + 'SampleEntry'](i.size)).hdr_size = i.hdr_size), (n.start = i.start)) : (r.warn('BoxParser', 'Unknown sample entry type: ' + i.type), (n = new l.SampleEntry(i.type, i.size, i.hdr_size, i.start))),
      ...
      (l.trefBox.prototype.parse = function (t) {
        for (var e, i; t.getPosition() < this.start + this.size; ) {
          if ((e = l.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== l.OK) return;
          (i = new l.TrackReferenceTypeBox(e.type, e.size, e.hdr_size, e.start)).write === l.Box.prototype.write && 'mdat' !== i.type && (r.info('BoxParser', 'TrackReference ' + i.type + ' box writing not yet implemented, keeping unparsed data in memory for later write'), i.parseDataAndRewind(t)),
            i.parse(t),
            this.boxes.push(i);
        }
      }),
      ...
      (l.sgpdBox.prototype.write = function (t) {
        ...
        for (this.writeHeader(t), t.writeString(this.grouping_type, null, 4), 1 === this.version && t.writeUint32(this.default_length), this.version >= 2 && t.writeUint32(this.default_sample_description_index), t.writeUint32(this.entries.length), e = 0; e < this.entries.length; e++)
    ...
    (u.prototype.setSegmentOptions = function (t, e, i) {
      ...
      (u.prototype.checkBuffer = function (t) {
        ...
        return 0 === t.byteLength
          ...
          : (r.info('ISOFile', 'Processing buffer (fileStart: ' + t.fileStart + ')'), (t.usedBytes = 0), this.stream.insertBuffer(t), this.stream.logBufferLevel(), !!this.stream.initialized() || (r.warn('ISOFile', 'Not ready to start parsing'), !1));
      }),
            ...
            for (e = 0; e < this.extractedTracks.length; e++) {
              ...
              for (i = a.trak; i.nextSample < i.samples.length && this.sampleProcessingStarted; ) {
                ...
                if (
                  (i.nextSample++,
                  a.samples.push(o),
                  (i.nextSample % a.nb_samples == 0 || i.nextSample >= i.samples.length) && (r.debug('ISOFile', 'Sending samples on track #' + a.id + ' for sample ' + i.nextSample), this.onSamples && this.onSamples(a.id, a.user, a.samples), (a.samples = []), a !== this.extractedTracks[e]))
                )
                  break;
              }
            }
      ...
      (u.prototype.seekTrack = function (t, e, i) {
        ...
        return (a = i.samples[d].offset + i.samples[d].alreadyRead), r.info('ISOFile', 'Seeking to ' + (e ? 'RAP' : '') + ' sample #' + i.nextSample + ' on track ' + i.tkhd.track_id + ', time ' + r.getDurationString(t, o) + ' and offset: ' + a), { offset: a, time: t / o };
      }),
      ...
      (u.prototype.processIncompleteBox = function (t) {
        ...
        return 'mdat' === t.type
          ? ((e = new l[t.type + 'Box'](t.size)),
            ...
            this.stream.seek(e.start + e.size, !1, this.discardMdatData) ? ((this.parsingMdat = null), !0) : (this.moovStartFound ? (this.nextParsePosition = this.stream.findEndContiguousBuf()) : (this.nextParsePosition = e.start + e.size), !1))
          : ('moov' === t.type && ((this.moovStartFound = !0), 0 === this.mdats.length && (this.isProgressive = !0)),
            !!this.stream.mergeNextBuffer && this.stream.mergeNextBuffer()
              ...
              : (t.type ? (this.moovStartFound ? (this.nextParsePosition = this.stream.getEndPosition()) : (this.nextParsePosition = this.stream.getPosition() + t.size)) : (this.nextParsePosition = this.stream.getEndPosition()), !1));
      }),
      ...
      (u.initSampleGroups = function (t, e, i, s, r) {
        ...
        for (e && (e.sample_groups_info = []), t.sample_groups_info || (t.sample_groups_info = []), a = 0; a < i.length; a++) {
          for (h = i[a].grouping_type + '/' + i[a].grouping_type_parameter, o = new d(i[a].grouping_type, i[a].grouping_type_parameter, i[a]), e && (e.sample_groups_info[h] = o), t.sample_groups_info[h] || (t.sample_groups_info[h] = o), n = 0; n < s.length; n++)
      ...
      (u.setSampleGroupProperties = function (t, e, i, s) {
        ...
        for (r in ((e.sample_groups = []), s)) {
          ...
          if (
            ...
            i >= s[r].last_sample_in_run && (s[r].last_sample_in_run < 0 && (s[r].last_sample_in_run = 0), s[r].entry_index++, s[r].entry_index <= s[r].sbgp.entries.length - 1 && (s[r].last_sample_in_run += s[r].sbgp.entries[s[r].entry_index].sample_count)),
            ...
            (a = s[r].fragment_description ? s[r].fragment_description : s[r].description),
              e.sample_groups[r].group_description_index > 0
                ? ((n = e.sample_groups[r].group_description_index > 65535 ? (e.sample_groups[r].group_description_index >> 16) - 1 : e.sample_groups[r].group_description_index - 1), a && n >= 0 && (e.sample_groups[r].description = a.entries[n]))
        ...
        if (
          ...
          for (e = 0; e < r.sample_sizes.length; e++) {
            ...
            (B.number = e),
              ...
              a ? (e >= w && (S++, w < 0 && (w = 0), (w += a.sample_counts[S])), (B.cts = t.samples[e].dts + a.sample_offsets[S])) : (B.cts = B.dts),
              o ? (e == o.sample_numbers[U] - 1 ? ((B.is_sync = !0), U++) : ((B.is_sync = !1), (B.degradation_priority = 0)), d && d.entries[x].sample_delta + E == e + 1 && ((B.subsamples = d.entries[x].subsamples), (E += d.entries[x].sample_delta), x++)) : (B.is_sync = !0),
                ...
                for (
                  ...
                  for (i = 0; i < g.sample_count; i++) {
                    ((m = {}).moof_number = this.lastMoofIndex),
                      ...
                      f.first_traf_merged || i > 0 ? (m.dts = f.samples[f.samples.length - 2].dts + f.samples[f.samples.length - 2].duration) : (p.tfdt ? (m.dts = p.tfdt.baseMediaDecodeTime) : (m.dts = 0), (f.first_traf_merged = !0)),
                      (m.cts = m.dts),
        ...
        (d.onReady = (t) => {
          if (t && t.videoTracks && t.videoTracks[0]) {
            ...
            const e = ((t) => {
              ...
              const s = new a(i);
              for (s.writeUint8(t.configurationVersion), s.writeUint8(t.AVCProfileIndication), s.writeUint8(t.profile_compatibility), s.writeUint8(t.AVCLevelIndication), s.writeUint8(t.lengthSizeMinusOne + 252), s.writeUint8(t.nb_SPS_nalus + 224), e = 0; e < t.SPS.length; e += 1)
  ...
  return class {
    constructor({ src: t, scrollyVideoContainer: e, cover: i = !0, sticky: s = !0, full: n = !0, trackScroll: a = !0, transitionSpeed: o = 8, frameThreshold: h = 0.1, useWebCodecs: d = !0, onReady: l = () => {}, debug: p = !1 }) {
      ...
      const f = new r().getEngine();
      (this.isSafari = 'WebKit' === f.name),
        ...
        (this.updateScrollPercentage = (t) => {
          ...
          this.debug && console.info('ScrollyVideo scrolled to', i), this.setTargetTimePercent(i, { jump: t });
        }),
        this.trackScroll
          ...
          : this.video.addEventListener('loadedmetadata', () => this.setTargetTimePercent(0, { jump: !0 }), { once: !0 }),
        (this.resize = () => {
    ...
    setCoverStyle(t) {
      if (this.cover) {
        ...
        this.debug && console.info('Container dimensions:', [e, i]), this.debug && console.info('Element dimensions:', [s, r]), e / i > s / r ? ((t.style.width = '100%'), (t.style.height = 'auto')) : ((t.style.height = 'auto'), (t.style.width = '100%'));
      }
    }
    async decodeVideo() {
    ...
    transitionToTargetTime({ jump: t, transitionSpeed: e = this.transitionSpeed, easing: i = null }) {
      ...
      const s = this.targetTime - this.currentTime,
        ...
        o = ({ startCurrentTime: s, startTimestamp: h, timestamp: d }) => {
          ...
          'function' == typeof requestAnimationFrame && (this.transitioningRaf = requestAnimationFrame((t) => o({ startCurrentTime: s, startTimestamp: h, timestamp: t })));
        };
      'function' == typeof requestAnimationFrame &&
        (this.transitioningRaf = requestAnimationFrame((t) => {
          o({ startCurrentTime: this.currentTime, startTimestamp: t, timestamp: t });
        }));
    }
    setTargetTimePercent(t, e = {}) {
      (this.targetTime = Math.max(Math.min(t, 1), 0) * (this.frames.length && this.frameRate ? this.frames.length / this.frameRate : this.video.duration)),
        (!e.jump && Math.abs(this.currentTime - this.targetTime) < this.frameThreshold) || (this.canvas || this.video.paused || this.video.play(), this.transitionToTargetTime(e));
    }
    setScrollPercent(t) {
